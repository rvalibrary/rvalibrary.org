...
/*
 ...
 Template Name: Public Answer Page
...
<div class="faq-answer faq-even" id="faqSection" >
  <div class="container">
    ...
    <h1 style="margin-bottom: 10px; color: #022437;">Newly Answered Questions</h1>
    <p style="padding-bottom: 20px;">Have a question? Submit your question above, search our database of gardening know-how or browse our list of newly answered questions. </p>
    ...
    <div style="text-align: center; margin-bottom: 10px;" class="container-fluid">
      ...
      <a href="https://rvalibrary.org/master-gardener/view?offset=0#faqSection">First</a> |
      ...
      <?php if($current_page_fixed == 1): ?>
        ...
        <?php while($current_page <= $pages && $current_page != 5): ?>
         <?php if($current_page_fixed != $current_page): ?>
          <a href="https://rvalibrary.org/master-gardener/view?offset=<?php echo ($current_page * $page_size) - $page_size ?>#faqSection"><?php echo $current_page ?></a>
          <?php $current_page++ ?>
          <?php else: ?>
      ...
      <?php endif; ?>
      | <a href="https://rvalibrary.org/master-gardener/view?offset=<?php echo (floor($total_count / $page_size) * $page_size) ?>#faqSection">Last</a>
      <div style="width: 100%; margin-top: 10px;">
        <?php if($offset != 0): ?>
        <a class="btn btn-primary" href="https://rvalibrary.org/master-gardener/view?offset=<?php echo ($offset - $page_size) ?>#faqSection">Previous</a>
        <?php endif; ?>
        <?php if(($offset + $page_size) < $total_count): ?>
        <a class="btn btn-primary" href="https://rvalibrary.org/master-gardener/view?offset=<?php echo ($offset + $page_size) ?>#faqSection">Next</a>
        <?php endif; ?>
      </div>
