...
?>
<div class="container-fluid" id="<?php echo get_sub_field('button_list_header') ?>" style="background-color: #013862;">
  <div class="container" style="padding: 2rem 0; min-height: 300px;">
    <div class="row">
      <div class="col-sm-12 col-md-4">
        <h1 class="header-gradient-underline"><?php echo get_sub_field('button_list_header'); ?></h1>
        <?php echo get_sub_field('button_list_description'); ?>
      </div>
