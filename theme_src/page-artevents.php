...
<div class="container" style="background-color: #022437; width: 100%; box-shadow: 0 -5px 8px rgba(0,0,0,0.3)">
	...
	<p style="color: white;"><?php the_field('footer_description'); ?></p>
		<p style="color: white; font-size: 13px;">Interested in exhibiting at Richmond Public Library? Download our <strong><a href="<?php the_field ('application_') ?>"> application </a></strong>. <br>For more information, please review our <a href="https://rvalibrary.org/about/library-policy/"><strong>policy</a></strong> regarding art submissions.
