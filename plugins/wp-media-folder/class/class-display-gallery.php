...
class WpmfDisplayGallery
{
    ...
    public function __construct()
    {
        ...
        add_filter('post_gallery', array($this, 'galleryShortcode'), 11, 3);
     ...
     */
    public function galleryShortcode($blank, $attr)
    {
        $post = get_post();
        static $instance = 0;
        $instance++;
     ...
     * @param $post_after : post content after update
     * @param $post_before : post content before update
     */
