...
(function($) {
    ...
    wpmfFoldersFiltersModule =  {
        ...
        generateDropdown : function($current_frame) {
            let clear_filters, my_medias, filter_type = '', filter_date = '', filter_size = '', filter_weight = '', sort_folder = '', sort_file = '';

            // Add folder ordering
            const folder_order_options = $current_frame.find('#media-order-folder option');
            if(folder_order_options.length) {
                sort_folder = '<li>'+wpmf.l18n.order_folder_label+'<span class="sub"><i class="material-icons">chevron_right</i></span><ul>';
            ...
            if(media_sort_options.length) {
                sort_file = '<li> '+wpmf.l18n.order_img_label+'<span class="sub"><i class="material-icons">chevron_right</i></span><ul>';
            ...
            return `<div class="wpmf-filters-dropdown">
                            <a href="#" class="wpmf-filters-dropdown-button">${wpmf.l18n.sort_label}</a>
                            <ul>
                                ${clear_filters}
         ...
         * @param filter_elem
         */
        toggleFilter : function(filter_elem) {
